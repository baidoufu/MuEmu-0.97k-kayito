...
CServerDisplayer::CServerDisplayer()
{
	...
	this->m_logfont = CreateFont(15, 0, 0, 0, FW_NORMAL, FALSE, FALSE, FALSE, GB2312_CHARSET, OUT_DEFAULT_PRECIS, CLIP_DEFAULT_PRECIS, NONANTIALIASED_QUALITY, DEFAULT_PITCH | FF_DONTCARE, "Verdana");
...
void CServerDisplayer::Init(HWND hWnd)
{
	...
	gLog.AddLog((GetPrivateProfileInt("Log", "LOG", 1, ".\\ConnectServer.ini") != 0), "LOG");
}
...
void CServerDisplayer::SetWindowName()
{
	...
	wsprintf(buff, "MuEmu ConnectServer Ex097 (QueueSize : %d)", gSocketManager.GetQueueSize());
...
void CServerDisplayer::PaintAllInfo()
{
	...
	if (gServerList.CheckJoinServerState() == false)
	{
